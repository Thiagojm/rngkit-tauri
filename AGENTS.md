...
- Checkpoints 3–18 of the original plan are implemented. Phase 1 of the
  ...
  Phase 2 and Phase 3 are complete and published in this app. Phase 3 passed
  automated and browser-integrated validation; native manual validation
  remains the active gate, and Phase 4 is not authorized.
